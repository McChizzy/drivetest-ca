...
const getSaskatchewanQuestions = (): Question[] => [
  {
    id: 3001,
    question: "To drive in Saskatchewan, what must you hold for the type of vehicle you want to operate?",
    options: ["A valid driver's licence", "A passport", "A vehicle registration permit", "A safety inspection card"],
    correctAnswer: 0,
    explanation: "SGI states that to drive in Saskatchewan you must hold a valid driver's licence for the type of vehicle you wish to operate.",
    image: "/saskatchewan-regina-skyline.jpg",
  },
  {
    id: 3002,
    question: "How many types of tests are required for all classes of licence in Saskatchewan?",
    options: ["One", "Two", "Three", "Four"],
    correctAnswer: 2,
    explanation: "SGI says all classes of licence require three types of tests: knowledge, vision, and road tests.",
  },
  {
    id: 3003,
    question: "What are the two parts of Saskatchewan's knowledge test?",
    options: ["Parking and highway driving", "Driving situations/rules of the road and sign identification", "Vision and reaction time", "Vehicle inspection and insurance"],
    correctAnswer: 1,
    explanation: "The knowledge tests consist of two parts: driving situations and rules of the road, and sign identification.",
    image: "/saskatchewan-regina-skyline.jpg",
  },
  {
    id: 3004,
    question: "How often may you write a Saskatchewan knowledge test?",
    options: ["Once a day", "Twice a day", "Once a week", "Unlimited times per day"],
    correctAnswer: 0,
    explanation: "SGI states that you may write the knowledge test only once per day.",
    image: "/saskatchewan-regina-skyline.jpg",
  },
  {
    id: 3005,
    question: "How long must a Class 7 driver keep that classification before becoming eligible for examinations toward another class?",
    options: ["3 months", "6 months", "9 months", "12 months"],
    correctAnswer: 2,
    explanation: "A driver with a Class 7 licence must retain that classification for at least nine months before becoming eligible for examinations toward another class.",
    image: "/saskatchewan-saskatoon-river.jpg",
  },
  {
    id: 3006,
    question: "If you are a first-time Saskatchewan driver between ages 15 and 18, what must you provide?",
    options: ["A completed Signature/Guarantor Form for First Time Drivers", "A commercial driver medical", "A vehicle purchase receipt", "A school attendance letter only"],
    correctAnswer: 0,
    explanation: "SGI requires first-time drivers aged 15 to 18 to provide a completed Signature/Guarantor Form for First Time Drivers.",
  },
  {
    id: 3007,
    question: "If you become a Saskatchewan resident, how long may you drive using your current driver's licence and vehicle plates after taking up residence?",
    options: ["30 days", "60 days", "90 days", "120 days"],
    correctAnswer: 2,
    explanation: "Full-time students are exempt, but if you become a Saskatchewan resident, SGI says you may drive using your current driver's licence and vehicle plates for 90 days after taking up residence.",
    image: "/saskatchewan-regina-skyline.jpg",
  },
  {
    id: 3008,
    question: "What should you do in Saskatchewan school zones if there are no posted signs?",
    options: ["Continue at the regular speed limit", "Reduce your speed and proceed cautiously", "Stop at every crosswalk", "Turn on hazard lights"],
    correctAnswer: 1,
    explanation: "SGI notes that each city or town sets school-zone speeds by local bylaw, but if there are no signs, drivers should still reduce speed and proceed cautiously.",
    image: "/signs/school-zone-sign.jpg",
  },
  {
    id: 3009,
    question: "If a peace officer asks to see your Saskatchewan driver's licence and you do not have it with you, what may happen?",
    options: ["Your vehicle is automatically impounded", "The officer may allow up to 48 hours to produce it", "You must retake your road test", "Your licence is cancelled immediately"],
    correctAnswer: 1,
    explanation: "SGI states that if you don't have your licence with you, the officer may allow you up to 48 hours to produce it.",
    image: "/saskatchewan-regina-skyline.jpg",
  },
  {
    id: 3010,
    question: "What does SGI say about using cellphones or electronic devices in the Saskatchewan knowledge test area?",
    options: ["They are allowed if muted", "They are allowed only for translations", "They are not allowed", "They are allowed after the sign-identification section"],
    correctAnswer: 2,
    explanation: "SGI says the use of cellphones or electronic devices is not allowed in the test area.",
    image: "/saskatchewan-regina-skyline.jpg",
  },
]
